...
public class DeviceTemplateExceptionHandler {
        ...
        @ExceptionHandler(DuplicateDeviceTemplateNameException.class)
        public ResponseEntity<ErrorResponse> handleDuplicateDeviceTemplateName(
                        DuplicateDeviceTemplateNameException ex,
                        HttpServletRequest request) {
